...
<html>
    <head>
        ...
        <title><?php echo $_SPRIT['PROJECT_TITLE']; ?></title>
        ...
        <!-- Theme style -->
        <link rel="stylesheet" href="../adminlte/assets/css/adminlte.min.css">
        <!-- Local -->
        <link rel="stylesheet" href="../adminlte/assets/css/local.css">
