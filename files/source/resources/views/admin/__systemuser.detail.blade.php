@include('admin.head')
<body class="hold-transition sidebar-mini layout-fixed text-sm" data-url-prefix="" data-page-initializing="1" data-page-url="__systemuser">
    ...
    <script src="/assets/admin/js/__systemuser.detail.js"></script>    
</body>
</html>