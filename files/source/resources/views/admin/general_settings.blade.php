@include('admin.head')
<body class="hold-transition sidebar-mini layout-fixed text-sm" data-url-prefix="" data-page-url="general_settings">
    ...
    <script src="/assets/admin/js/general_settings.js"></script>    
</body>
</html>