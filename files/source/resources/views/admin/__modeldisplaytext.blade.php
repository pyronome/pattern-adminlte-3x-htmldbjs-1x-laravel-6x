...
<body class="hold-transition sidebar-mini layout-fixed text-sm" data-url-prefix="" data-page-url="__modeldisplaytext">
    ...
    <div id="ModelDisplayTextHTMLDB"
        ...
        data-htmldb-read-url="htmldb/__modeldisplaytext/get_model_display_texts"
        data-htmldb-write-url="htmldb/__modeldisplaytext/post_model_display_texts"
    ...
    <div id="PropertyListHTMLDB"
        ...
        data-htmldb-read-url="htmldb/__modeldisplaytext/get_model_property_list">
    </div>
    <script type="text/html" 
    ...
    <script src="/assets/admin/js/__modeldisplaytext.js"></script>    
</body>
</html>