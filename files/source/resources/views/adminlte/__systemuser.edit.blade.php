@include('admin.head')
<body class="hold-transition sidebar-mini layout-fixed text-sm" data-url-prefix="" data-page-url="__systemuser">
                                            ...
                                            <div class="divPermissionContainer">
                                                <table class="table table-bordered table-permission">
                                                    ...
                                                    <tbody id="tbodyMenuPermission">
                                                        @include('admin.__systemuser_permissions_edit')
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script src="/assets/adminlte/js/__systemuser.edit.js"></script>    
</body>
</html>